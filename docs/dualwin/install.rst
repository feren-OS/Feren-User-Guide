...
Step 4: Replace the free space beside Microsoft Windows
----------------
...
Select :guilabel:`Replace a partition`, click the free space you made in Disk Management, to the right of Microsoft Windows's partition, from the "Current" partition bar at the bottom of the window and then click :guilabel:`Next`.

.. warning::
    Make sure you select the free space and not an existing partition to replace!

.. figure:: ../images/calamaresdualwin.png
    :width: 1024px
    :align: center
...
* `Setting up Feren OS <https://feren-os-user-guide.readthedocs.io/en/latest/dualwin/initialsetup.html>`_
