...
Select :guilabel:`Replace a partition`, click your old Linux partition from the "Current" partition bar at the bottom of the window and then click :guilabel:`Next`.
...
* `Setting up Feren OS <https://feren-os-user-guide.readthedocs.io/en/latest/replacelinux/initialsetup.html>`_
