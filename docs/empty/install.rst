...
Now you'll have the option to either erase your disk or partition Feren OS manually.
...
.. figure:: ../images/calamaresempty.png
    :width: 1024px
    :align: center
...
* `Setting up Feren OS <https://feren-os-user-guide.readthedocs.io/en/latest/empty/initialsetup.html>`_
