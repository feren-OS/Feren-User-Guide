...
3. Before your computer boots your current Feren OS install you should see your manufacturer's logo. Check the screen or your computer's documentation to know which key to press and instruct your computer to boot on USB (or DVD).
...
* `Accessibility <https://feren-os-user-guide.readthedocs.io/en/latest/reinstall/accessibility.html>`_
