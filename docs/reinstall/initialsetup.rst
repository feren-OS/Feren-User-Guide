...
Welcome back to Feren OS! You now need to set Feren OS up with a user account.
...
* `Restoring data with Transfer Tool <https://feren-os-user-guide.readthedocs.io/en/latest/reinstall/transferrestore.html>`_
