...
Step 4: Replace Feren OS
----------------

Now you'll have the option to either erase your disk, replace a partition with Feren OS, install Feren OS alongside your current Feren OS or partition Feren OS manually.
...
Select :guilabel:`Replace a partition`, click your old Feren OS partition from the "Current" partition bar at the bottom of the window and then click :guilabel:`Next`.

.. warning::
    Before installing Feren OS over your current Feren OS ensure you transferred your data elsewhere as choosing :guilabel:`Replace a partition with Feren OS` will destroy all the data from your old Feren OS's partition and you cannot undo that once it is done.

.. figure:: ../images/calamaresreplaceferen.png
    :width: 1024px
    :align: center
...
* `Setting up Feren OS <https://feren-os-user-guide.readthedocs.io/en/latest/reinstall/initialsetup.html>`_
