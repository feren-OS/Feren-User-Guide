...
Step 4: Erase Microsoft Windows
----------------

Now you'll have the option to either erase your disk, replace a partition with Feren OS, install Feren OS alongside your current Operating System or partition Feren OS manually.
...
Select :guilabel:`Erase disk` and then click :guilabel:`Next`.

.. warning::
    Before installing Feren OS ensure you transferred your data elsewhere as choosing :guilabel:`Erase disk` will destroy ALL the data on the computer's hard drive, and you cannot undo that once it is done.

.. figure:: ../images/calamareserasewin.png
    :width: 1024px
    :align: center
...
* `Setting up Feren OS <https://feren-os-user-guide.readthedocs.io/en/latest/replacewin/initialsetup.html>`_
