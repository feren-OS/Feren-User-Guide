...
Step 4: Replace the free space beside Apple macOS
----------------
...
Select :guilabel:`Replace a partition`, click the free space you made in Disk Utility, to the right of Apple macOS's partition, from the "Current" partition bar at the bottom of the window and then click :guilabel:`Next`.
...
* `Setting up Feren OS <https://feren-os-user-guide.readthedocs.io/en/latest/dualmac/initialsetup.html>`_
