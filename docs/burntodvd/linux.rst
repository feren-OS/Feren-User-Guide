...
Burning your Feren OS ISO file to a DVD using Linux or Feren OS depends on the Operating System. In Ubuntu's case there is no disc burner installed, so you'll need to install it first.
