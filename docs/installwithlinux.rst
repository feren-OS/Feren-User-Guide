...
Now you'll have the option to either erase your disk, replace a partition with Feren OS or use partition Feren OS manually. Select :guilabel:`Install alongside` and then click your old Linux Distribution's root partition from the 'Current' partition bar at the bottom of the window. Now choose how big Feren OS should be (the new Feren OS partition is the right-side partition (pictured in red below)) and then click :guilabel:`Next`.
...
.. figure:: images/calamaresalongsidelinuxpartition.png
    :width: 1024px
    :align: center
...
You will now be taken to a screen where you can select whether you want to :guilabel:`Install Feren alongside (your current Linux Distribution)`, :guilabel:`Erase disk and install Feren` OS or do :guilabel:`Something else` to manually partition Feren OS yourself. Select :guilabel:`Install Feren alongside (your current Linux Distribution)` and click :guilabel:`Install Now`.

.. figure:: images/ubiquityalongsidelinux.png
    :width: 877px
    :align: center

You will now be taken to a screen where you can split the size of the current Linux Distribution's partition between that partition and a new partition for the soon-to-be Feren OS installation to be on. Once you have picked a size, click :guilabel:`Continue`.

.. figure:: images/ubiquityalongsidelinux2.png
    :width: 877px
    :align: center
