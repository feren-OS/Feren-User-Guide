...
.. hint::
    Not to be confused with "Windows XP Professional 64-Bit Edition", which means Feren OS is not compatible with your machine.
...
* `Downloading Feren OS <https://feren-os-user-guide.readthedocs.io/en/latest/getiso.html>`_