...
Since you're dual-booting with Feren OS, a boot options screen will appear like the one depicted below:
...
3. Restart the computer once finished. You have successfully set up Feren OS and can start using it!
